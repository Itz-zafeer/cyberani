...
const NewsBlogsContainer = ({ fromBlogs, link }) => {
  return (
    ...
    >
        ...
        <div className="flex flex-col items-start">
          {fromBlogs ? (
            <h2 className={`lg:text32 mtext32 font-medium lg:pb-sp10 pb-5`}>
              Our{""}
              {""}{" "}
              <span className={`${fromBlogs ? "text-bright-teal" : ""}`}>
                Blogs
              </span>
            </h2>
          ) : (
      ...
      <div className="px-5 sm:px-[4.8vw] lg:px-0 lg:myContainer flex gap-5 lg:gap-sp48 my-12 lg:my-sp48 lg:justify-between whitespace-nowrap lg:whitespace-normal overflow-auto lg:overflow-visible hideScroll lg:flex-wrap">
